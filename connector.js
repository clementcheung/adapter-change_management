...
class ServiceNowConnector {
  ...
  get(callback) {
    ...
    *
    * @param {object} postCallOptions - Passed call options.
    * @param {string} postCallOptions.serviceNowTable - The table target of the ServiceNow table API.
    * @param {iapCallback} callback - Callback a function.
    * @param {(object|string)} callback.data - The API's response. Will be an object if sunnyday path.
    *   Will be HTML text if hibernating instance.
    * @param {error} callback.error - The error property of callback.
   ...
   * @memberof ServiceNowConnector
   * @method constructUri
   * @summary Constructs Uri with Optional Query
   ...
   * @summary Check if ServiceNow Instance is Hibernating
  ...
  isHibernating(response) {
    ...
    * @memberof ServiceNowConnector
    * @method sendRequest
    * @summary Builds final options arguement for request function
